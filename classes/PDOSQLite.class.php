...
class PDOSQLite {
	...
	private function __construct ($dbName) {
		...
		self::$_dbLink->query('CREATE TABLE IF NOT EXISTS users (admin INT(1), name VARCHAR(30), email VARCHAR(80), password VARCHAR(64), blocked INT(1), theme VARCHAR(50), font VARCHAR(30), color_scheme VARCHAR(20), language VARCHAR(5), favorite_lang TEXT)');
